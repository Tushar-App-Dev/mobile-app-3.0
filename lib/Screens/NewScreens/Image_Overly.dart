...
class _OverlayImagePageState extends State<OverlayImagePage> {
  ...
  void getFarmDetails(String farmid) async {
    ...
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var api_key = prefs.getString('api_key');
    var response = await http.get(Uri.parse('https://api.mapmycrop.store/farm/$farmid?api_key=$api_key'));
    //print(response.body);
    var data = await jsonDecode(response.body);
    print(data);
    setState((){
  ...
  getStandardYield(String cropname) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var api_key = prefs.getString('api_key');
    var response = await http.get(Uri.parse('https://api.mapmycrop.store/crop/$cropname?api_key=$api_key'));
