List<CategorieModel> getCategories(){
  ...
  categorieModel = new CategorieModel();
  categorieModel.categorieName = "agriculture";
  categorieModel.imageAssetUrl = "https://m.economictimes.com/thumb/msid-84896725,width-1200,height-900,resizemode-4,imgsize-698681/1.jpg";
  myCategories.add(categorieModel);
